...
{
    NSData *asData = [NSJSONSerialization dataWithJSONObject:student.jsonValue                  // Lägg till student i json-format i asData
    ...
    NSURL *url= [NSURL URLWithString:@"http://funking.iriscouch.com/student_db"];               // Skapa variabeln url som innehåller adressen t db
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url                      
                                                       ...
                                                       timeoutInterval:10.0];                   // Skapar request som...
                                                                                                // @method setURL. Abstract Sets the URL of the receiver. param URL The new URL for the receiver.
